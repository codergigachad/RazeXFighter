...
def draw_menu():
    if PAUSE_MENU:
        ...
        draw_text("Developed by", menu_font_small, GREEN, 370, 400)
        draw_text("SUMOSP & PEEYUSH-AGARWAL26", menu_font_small, GREEN, 140, 460)
    else:
        name_len = GAME_NAME.__len__()
        name_pos_x = SCREEN_WIDTH - ((name_len * 30) * 2)
        screen.fill((0, 0, 0))
...
while run:
    ...
    if MENU == True:
        ...
        draw_text("RAZE", score_font, WHITE, 20, 30)
        draw_text("OMEN", score_font, WHITE, 910, 30)
